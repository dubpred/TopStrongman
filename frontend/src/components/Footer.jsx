...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-[#1E222D] bg-[#0F1115] py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 pt-6 border-t border-[#1E222D]/60 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-400 font-mono gap-2">
