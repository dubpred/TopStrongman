  ...
  return (
    <div className="space-y-10">
      ...
      <div className="bg-[#121212] border-2 border-[#262626] rounded-none p-6 md:p-8 shadow-2xl">
        <div className="inline-flex items-center space-x-2 px-3 py-1 bg-[#181818] border border-red-600/40 text-red-500 text-xs font-mono font-bold uppercase tracking-wider mb-3 rounded-none">
        ...
        <h1 className="font-display text-4xl md:text-6xl font-black uppercase text-white tracking-wider">
          COMPETITION <span className="text-red-600">TIERS & MULTIPLIERS</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {tiers.map((t) => (
          <div key={t.tier} className="bg-[#121212] p-6 border-2 border-[#262626] hover:border-red-600/60 space-y-4 rounded-none shadow-xl transition-all">
            <div className="flex items-center justify-between">
              <span className={`px-3 py-1 font-display text-lg font-black rounded-none uppercase ${
                t.tier === 'TIER 1' ? 'bg-red-600 text-white shadow-rogue-red' :
              ...
              <span className="font-mono text-xs font-black uppercase px-3 py-1 bg-[#181818] text-red-500 rounded-none border border-red-900/40">
                {t.multiplier}
              </span>
            </div>
              ...
              <ul className="space-y-1.5 font-mono text-xs text-zinc-300">
                {t.shows.map((s, idx) => (
                  <li key={idx} className="flex items-center space-x-2">
                    <span className="w-1.5 h-1.5 bg-red-600 shrink-0 rounded-none"></span>
                    <span>{s}</span>
                  </li>
                ))}
              </ul>
      ...
      <div className="bg-[#121212] p-6 md:p-8 rounded-none border-2 border-[#262626] space-y-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-2">
          ...
          <div className="bg-[#181818] rounded-none p-5 border-2 border-[#262626] space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-red-500 font-bold uppercase">STEP 1 • PURE RANKINGS</span>
            ...
            <div className="bg-[#080808] p-3 rounded-none border border-[#333] font-mono text-xs text-red-400 text-center font-bold">
          ...
          <div className="bg-[#181818] rounded-none p-5 border-2 border-[#262626] space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-red-500 font-bold uppercase">STEP 2 • FIELD STRENGTH</span>
        ...
        <div className="bg-[#080808] p-5 rounded-none border-2 border-[#262626] space-y-3 font-mono text-xs">
          <div className="text-red-500 font-bold uppercase tracking-wider flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-center">
            ...
            <div className="bg-[#121212] p-3 rounded-none border border-[#262626]">
              ...
              <div className="font-display text-2xl font-black text-white">450 - 620 PTS</div>
      ...
      <div className="bg-[#121212] p-6 md:p-8 rounded-none border-2 border-[#262626] space-y-4 shadow-2xl">
        ...
        <div className="bg-[#080808] p-4 rounded-none border-2 border-[#262626] font-mono text-xs text-red-400 text-center font-bold">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 font-mono text-center text-xs">
          <div className="bg-[#181818] p-2.5 rounded-none border border-[#262626]">
            ...
            <div className="font-bold text-red-500">100% (1.0)</div>
          </div>
          <div className="bg-[#181818] p-2.5 rounded-none border border-[#262626]">
            <div className="text-[10px] text-zinc-400">2ND BEST</div>
            <div className="font-bold text-red-500">85% (0.85)</div>
          </div>
          <div className="bg-[#181818] p-2.5 rounded-none border border-[#262626]">
            <div className="text-[10px] text-zinc-400">3RD BEST</div>
            <div className="font-bold text-red-500">70% (0.70)</div>
          </div>
          <div className="bg-[#181818] p-2.5 rounded-none border border-[#262626]">
        ...
        <div className="bg-[#080808] p-3.5 rounded-none border-2 border-[#262626] font-mono text-xs text-red-500 text-center font-bold">
      ...
      <div className="bg-[#121212] p-6 md:p-8 rounded-none border-2 border-[#262626] space-y-4 shadow-2xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 pt-2 font-mono text-center">
          ...
          <div className="bg-[#181818] p-4 rounded-none border-2 border-[#262626]">
            ...
            <div className="font-display text-3xl font-black text-white">3.0x</div>
