...
export default function FullRankings({ rankings: initialRankings, onSelectCompetitor, formula }) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#12161F] border border-[#252E3E] rounded-xl p-6 md:p-8 shadow-2xl">
        <div>
        ...
        {/* Division Switcher */}
        <div className="flex items-center space-x-1.5 bg-[#090B0E] p-1.5 rounded-lg border border-[#252E3E]">
          <button
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="relative col-span-1 sm:col-span-2">
            ...
            <input
              ...
              className="w-full bg-[#0C0F14] text-white font-sans text-xs rounded-lg pl-10 pr-3 py-2.5 border border-[#252E3E] focus:outline-none focus:border-dew-green transition-all placeholder:text-gray-500 shadow-inner"
            />
          </div>
          ...
          <button
            ...
            className={`flex items-center justify-between px-4 py-2.5 rounded-lg font-mono text-xs font-bold transition-all border ${
              isAdvancedActive || showAdvanced
                ...
                : 'bg-[#12161F] text-gray-200 border-[#252E3E] hover:border-dew-green/50'
            }`}
          >
        ...
        {showAdvanced && (
          <div className="bg-[#12161F] border border-[#252E3E] rounded-xl p-5 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200 shadow-2xl">
            <div className="flex items-center justify-between border-b border-[#252E3E] pb-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-[#0C0F14] text-dew-green font-mono text-xs font-bold rounded-lg px-3 py-2.5 border border-[#252E3E] focus:outline-none focus:border-dew-green transition-all appearance-none cursor-pointer"
                  >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-[#0C0F14] text-gray-200 font-mono text-xs font-bold rounded-lg px-3 py-2.5 border border-[#252E3E] focus:outline-none focus:border-dew-green transition-all appearance-none cursor-pointer"
                  >
      ...
      <div className="block sm:hidden space-y-2.5">
        {pagedRankings.map((item) => (
          <div
            ...
            className="dew-glass-card p-3.5 flex items-center justify-between gap-3 active:scale-[0.98] transition-transform cursor-pointer border border-[#252E3E] hover:border-dew-green/50"
          >
      ...
      <div className="hidden sm:block dew-glass-card overflow-hidden border border-[#252E3E]">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#161B26] border-b border-[#252E3E] text-xs font-mono text-gray-300 uppercase tracking-wider">
            ...
            <tbody className="divide-y divide-[#252E3E]/60 text-sm bg-[#12161F]">
              {pagedRankings.map((item) => (
                <tr
                  key={item.competitor.id}
                  onClick={() => onSelectCompetitor(item)}
                  className="hover:bg-[#181E2B] transition-colors cursor-pointer group"
                >
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between px-2 pt-2">
          <button
            ...
            disabled={safePage === 1}
            className="flex items-center space-x-2 px-3.5 py-1.5 rounded-lg bg-[#12161F] border border-[#252E3E] text-gray-300 font-mono text-xs font-bold disabled:opacity-30 hover:border-dew-green hover:text-white transition-all shadow-sm"
          >
